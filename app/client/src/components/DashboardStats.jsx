...
import CreateShipmentModal from "./CreateShipmentModel";
                ...
                {isLoading ? (
                    ...
                    <div className="w-1/2 h-full p-12 flex flex-col justify-start">
                        ...
                        <button
                            ...
                            transition-all duration-300 transform hover:bg-cyan-500 hover:scale-105 cursor-pointer hover:shadow-lg animate-fadeIn"
